...
> **Project Title:** Voltage Stability Assessment Methods in Large-Scale Power Systems
...
| **Synchrophasor**| `PMUs`, `Thevenin Tracking` | ⏱️ Real-time monitoring | 📡 Latency dependent |
...
| :--- | :--- | :--- |
| **Inverter Challenge** | Loss of inherent reactive power support from IBRs. | Granular, real-time tracking of thinning margins. |
| **Evolution of Tools** | Offline methods are too slow for fast grid dynamics. | **PMU-based monitoring** for instant situational awareness. |
| **Hybrid Frameworks** | Pure AI can violate physical grid constraints. | **Physics-Guided AI (PIML)** ensures law-abiding predictions. |
...
---
<p align="center">
  <i>Project completed as part of the <b>ENEL 670: Power System Analysis Application</b> curriculum.</i>
</p>
